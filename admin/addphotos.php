...
$con=mysqli_connect('localhost','root','','jenil');
  ...
  if(isset($_POST['save'])){
    ...
    // $img=implode(',',$img);
    $sql_insert="insert into addphotos(title,content,img,u_id) values('$title','$content','$img','$x')";
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Content" name="title">
                  </div>
                  <div class="form-group">
