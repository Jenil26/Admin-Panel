...
$con=mysqli_connect('localhost','root','','jenil');
  ...
  if(isset($_POST['save'])){
    ...
    // $img=implode(',',$img);
    $sql_insert="insert into contentwithphoto(title,content,content2,img,u_id) values('$title','$content','$content2','$img','$x')";
              ...
              <form method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Content" name="content2">
                  </div>
                  <div class="form-group">
