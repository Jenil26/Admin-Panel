...
if (isset($_GET['d_id'])) {
  $id=$_GET['d_id'];
         ...
         $delete_data="delete from slider where id='$id'";
...
$a=$_SESSION['user_id'];
$sql="select * from slider where u_id='$a'";
...
// $sql_select= "select * from slider limit $start, $limit";
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><a href="datatable.php?d_id=<?php echo @$row['id']; ?>">Delete</a></td>
                ...
                <?php for($i=1; $i<=$page; $i++)  { ?>
                  <a href="datatable.php?page_no=<?php echo $i; ?>"><?php echo $i; ?></a>
                  <?php } ?>

 <?php	
	if($page_no>1)
	{
		echo "<a margin:50px; href='datatable.php?page_no=".($page_no-1)."'>Pre</a>";
	}
	if($i>$page_no)
	{
		echo "<a margin:50px href='datatable.php?page_no=".($page_no+1)."'>NXT</a>";
	}
?> 
