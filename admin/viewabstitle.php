...
if (isset($_GET['d_id'])) {
  $id=$_GET['d_id'];
         ...
         $delete_data="delete from abstitle where id='$id'";
...
// }
$limit=2;
$sql_select = "select * from abstitle";
...
$a=$_SESSION['user_id'];
$sql="select * from abstitle where u_id='$a'";
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php foreach($arr as $row){?>
                    ...
                    <td><a href="viewabstitle.php?d_id=<?php echo @$row['id']; ?>">Delete</a></td>
                ...
                <?php for($i=1; $i<=$page; $i++)  { ?>
                  <a href="viewabstitle.php?page_no=<?php echo $i; ?>"><?php echo $i; ?></a>
                  <?php } ?>

 <?php	
	if($page_no>1)
	{
		echo "<a margin:50px; href='viewabstitle.php?page_no=".($page_no-1)."'>Pre</a>";
	}
	if($i>$page_no)
	{
		echo "<a margin:50px href='viewabstitle.php?page_no=".($page_no+1)."'>NXT</a>";
	}
?> 
