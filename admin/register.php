...
if(isset($_POST['submit']))
 {
  ...
  if($password==$repassword)
   { 
     $sql_insert="insert into login(name,email,password,Repassword) values('$name','$email','$password','$repassword')";
     mysqli_query($con,$sql_insert);
  }
  else
  {
   echo '<script>alert("Please Enter Valid Repassword")</script>'; 
  }
}
