...
$con=mysqli_connect('localhost','root','','jenil');
  ...
  if(isset($_POST['save'])){
    ...
    // $img=implode(',',$img);
    $sql_insert="insert into abstitle(title,btn1) values('$title','$btn1')";
              ...
              <form method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Button Name" name="btn1">
                  </div>
                  <!-- <div class="form-group">
